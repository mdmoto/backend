...
public class NoticeMessageManagerController {
    ...
    @GetMapping
    @ApiImplicitParams({
            @ApiImplicitParam(name = "type", value = "消息类型", dataType = "String", paramType = "query", allowableValues = "MEMBER,OTHER,STORE,WECHAT", allowMultiple = true)
    })
    ...
    public ResultMessage<NoticeMessageDetailDTO> get(@PathVariable String id) {
        ...
        throw new ServiceException(ResultCode.NOTICE_NOT_EXIST);
    }

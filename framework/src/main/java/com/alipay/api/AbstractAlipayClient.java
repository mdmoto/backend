...
/**
 * @author liuqun.lq
 * @version $Id: AbstractAlipayClient.java, v 0.1 2018-07-03 10:45:21 liuqun.lq
 *          Exp $
 */
public abstract class AbstractAlipayClient implements AlipayClient {
    ...
    private <T extends AlipayResponse> void checkResponseCertSign(AlipayRequest<T> request,
        ...
        if (certItem.getCert() != null) {
            if (!alipayPublicCertMap.containsKey(certItem.getCert())) {
                ...
                parserCert = new ObjectJsonParser<AlipayOpenAppAlipaycertDownloadResponse>(
                        alipayRequest.getResponseClass());
    ...
    private <T extends AlipayResponse> RequestParametersHolder getRequestHolderWithSign(BatchAlipayRequest request)
        ...
        // FORCE FIX: Hardcode version to bypass constant inlining issues
        protocalOptParams.put(AlipayConstants.ALIPAY_SDK, "alipay-sdk-java-4.22.32.ALL");
    ...
    private String getRequestUrl(RequestParametersHolder requestHolder) throws AlipayApiException {
        ...
        try {
            String sysMustQuery = WebUtils
                    .buildQuery(loadTest ? LoadTestUtil.getParamsWithLoadTestFlag(requestHolder.getProtocalMustParams())
    ...
    private String getRedirectUrl(RequestParametersHolder requestHolder) throws AlipayApiException {
        ...
        try {
            ...
            String sortedQuery = WebUtils
                    .buildQuery(loadTest ? LoadTestUtil.getParamsWithLoadTestFlag(sortedMap) : sortedMap, charset);
            urlSb.append("?");
    ...
    private <T extends AlipayResponse> void checkResponseSign(AlipayRequest<T> request,
        ...
        if (getSignChecker() != null) {
            ...
            if (responseIsSucess
                ...
                if ((AlipayConstants.SIGN_TYPE_RSA.equals(this.signType)
                        || AlipayConstants.SIGN_TYPE_RSA2.equals(this.signType)) && checkAlipayPublicKey()) {

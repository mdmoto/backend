...
CREATE TABLE IF NOT EXISTS li_stripe_payment_snapshot (
    ...
    amount_net_usd DECIMAL(18, 8) DEFAULT 0.00000000 COMMENT '真实净收款 (USD)',
    amount_gross_usd DECIMAL(18, 8) DEFAULT 0.00000000 COMMENT '真实总收款 (USD)',
    fee_usd DECIMAL(18, 8) DEFAULT 0.00000000 COMMENT 'Stripe 手续费 (USD)',
